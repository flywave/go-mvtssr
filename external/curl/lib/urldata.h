...
struct connectdata {
 ...
 /* connecttime: when connect() is called on the current IP address. Used to
  ...
  curl_resolver_dns_callback fresolverdns; /* function resolver dns cache */
  void *resolverdns_client;
  
  curl_pre_recved_callback fprerecved; /* function for pre recved data */
  void *prerecved_client;
  
  curl_pre_send_callback fpresend; /* function for pre send data */
  void *presend_client;
  
  curl_load_cert_file_callback floadcertfile; /* function for pre send data */
  void *loadcertfile_client;
  
  curl_unload_cert_file_callback funloadfile; /* function for pre send data */
  void *unloadfile_client;
...
struct UserDefined {
  ...
  curl_connect_callback fconnect; /* function for connect
                                         the address */
  
  void *connect_client;
  curl_setsockopt_callback fsetsockopt;
  
  void *setsockopt_client;
  
  curl_getsockopt_callback fgetsockopt;
  
  void *getsockopt_client;
  curl_bind_callback fbind; /* function for connect
                                   the address */
  
  void *bind_client;
    
  curl_updateconninfo_callback fupdateconninfo;
  void *updateconninfo_client;
...
/* Here follows boolean settings that define how to behave during
  ...
  curl_resolver_dns_callback fresolverdns; /* function for resolver
  ...
  curl_load_cert_file_callback floadcertfile; /* function for load cert file */
  void *loadcertfile_client;
  
  curl_unload_cert_file_callback funloadfile; /* function for unload cert file */
  void *unloadfile_client;
};
