# Windows platform: EGL+ANGLE headless backend (Direct3D via ANGLE)

find_package(PkgConfig QUIET)

target_compile_definitions(mbgl-core PUBLIC MBGL_USE_GLES2)
...
# The EGL headless backend source is shared with Linux — EGL is cross-platform.
# On Windows, ANGLE provides EGL + GLESv2 via Direct3D.
set(EGL_BACKEND_SRC "${PROJECT_SOURCE_DIR}/platform/linux/src/headless_backend_egl.cpp")
if(EXISTS ${EGL_BACKEND_SRC})
    target_sources(mbgl-core PRIVATE ${EGL_BACKEND_SRC})
endif()
