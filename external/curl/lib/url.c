...
static struct connectdata *allocate_conn(struct Curl_easy *data)
{
  ...
  conn->fresolverdns = data->set.fresolverdns;
  conn->resolverdns_client = data->set.resolverdns_client;

  conn->fprerecved = data->set.fprerecved;
  conn->prerecved_client = data->set.prerecved_client;
  
  conn->fpresend = data->set.fpresend;
  conn->presend_client = data->set.presend_client;
  
  conn->floadcertfile = data->set.floadcertfile;
  conn->loadcertfile_client = data->set.loadcertfile_client;
  
  conn->funloadfile = data->set.funloadfile;
  conn->unloadfile_client = data->set.unloadfile_client;
