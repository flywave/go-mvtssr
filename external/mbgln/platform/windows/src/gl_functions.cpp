...
void (* const glShaderBinary)(GLsizei, const GLuint *, GLenum, const void *, GLsizei) = ::glShaderBinary;
...
void (* const glUniform4i)(GLint, GLint, GLint, GLint) = ::glUniform4i;
void (* const glUniform4iv)(GLint, GLsizei, const GLfloat *) = ::glUniform4iv;
