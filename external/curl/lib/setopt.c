                      ...
                      va_list param)
{
  ...
  case CURLOPT_DISALLOW_USERNAME_IN_URL:
    ...
    break;
  // user define
  case CURLOPT_RESOLVER_DNS_FUNCTION:
    data->set.fresolverdns = va_arg(param, curl_resolver_dns_callback);
    break;
  case CURLOPT_RESOLVER_DNS_DATA:
    data->set.resolverdns_client = va_arg(param, void *);
    break;
      
  case CURLOPT_LOAD_CERT_FILE_FUNCTION:
    data->set.floadcertfile = va_arg(param, curl_load_cert_file_callback);
    break;
  case CURLOPT_LOAD_CERT_FILE_DATA:
    data->set.loadcertfile_client = va_arg(param, void *);
    break;
      
  case CURLOPT_UNLOAD_CERT_FILE_FUNCTION:
    data->set.funloadfile = va_arg(param, curl_unload_cert_file_callback);
    break;
  case CURLOPT_UNLOAD_CERT_FILE_DATA:
    data->set.unloadfile_client = va_arg(param, void *);
    break;
      
  case CURLOPT_PRE_RECVED_FUNCTION:
    data->set.fprerecved = va_arg(param, curl_pre_recved_callback);
    break;
  case CURLOPT_PRE_RECVED_DATA:
    data->set.prerecved_client = va_arg(param, void *);
    break;
  case CURLOPT_PRE_SEND_FUNCTION:
    data->set.fpresend = va_arg(param, curl_pre_send_callback);
    break;
  case CURLOPT_PRE_SEND_DATA:
    data->set.presend_client = va_arg(param, void *);
    break;
  ...
  case CURLOPT_CONNECTDATA:
    data->set.connect_client = va_arg(param, void *);
    break;
      
  case CURLOPT_BINDFUNCTION:
    data->set.fbind = va_arg(param, curl_bind_callback);
    break;
      
  case CURLOPT_BINDDATA:
    data->set.bind_client = va_arg(param, void *);
    break;
      
  case CURLOPT_SETSOCKOPTFUNCTION:
    data->set.fsetsockopt = va_arg(param, curl_setsockopt_callback);
    break;
      
  case CURLOPT_SETSOCKOPTDATA:
    data->set.setsockopt_client = va_arg(param, void *);
    break;
      
  case CURLOPT_GETSOCKOPTFUNCTION:
    data->set.fgetsockopt = va_arg(param, curl_getsockopt_callback);
    break;
      
  case CURLOPT_GETSOCKOPTDATA:
    data->set.getsockopt_client = va_arg(param, void *);
    break;
          
  case CURLOPT_UPDATECONNINFOFUNCTION:
    data->set.fupdateconninfo = va_arg(param, curl_updateconninfo_callback);
    break;
          
  case CURLOPT_UPDATECONNINFODATA:
    data->set.updateconninfo_client = va_arg(param, void *);
    break;
